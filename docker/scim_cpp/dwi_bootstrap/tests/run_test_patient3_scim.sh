...
# set scan directory 
d=/fileserver/external/body/serge/s20210809-ivim-cpp-build/dwi_bootstrap_v1/patient3/

# set mask path 
#mask=$d/mask_test.nrrd
mask=$3
...
# run 
$binary --optMode FBM -n $n_bvals -i  $txt_file -g 5 -o $outdir -m $mask
